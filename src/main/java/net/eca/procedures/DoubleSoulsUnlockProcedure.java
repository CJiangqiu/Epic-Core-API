...
public class DoubleSoulsUnlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (((LivingEntity) entity).getAttribute(EpicCoreApiModAttributes.SKILLPOINTS.get()).getValue() >= 1) {
			((LivingEntity) entity).getAttribute(EpicCoreApiModAttributes.SKILLPOINTS.get())
					.addPermanentModifier((new AttributeModifier(UUID.fromString("345f7d42-e0d3-450e-a1bd-9d73340b4bc9"), "skill_points_reduce", (-1), AttributeModifier.Operation.ADDITION)));
			...
			entity.getPersistentData().putBoolean("double_souls", true);
		}
	}
}
