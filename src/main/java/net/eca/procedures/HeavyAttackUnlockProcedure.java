	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (((LivingEntity) entity).getAttribute(EpicCoreApiModAttributes.SKILLPOINTS.get()).getValue() >= 1) {
			((LivingEntity) entity).getAttribute(EpicCoreApiModAttributes.SKILLPOINTS.get())
					.addPermanentModifier((new AttributeModifier(UUID.fromString("2b401969-9ae3-416c-af50-5848b613285e"), "skill_points_reduce", (-1), AttributeModifier.Operation.ADDITION)));
			...
			entity.getPersistentData().putBoolean("heavy_attack", true);
		}
	}
}
