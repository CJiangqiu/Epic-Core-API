...
public class HiddenInTheShadowUnlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (((LivingEntity) entity).getAttribute(EpicCoreApiModAttributes.SKILLPOINTS.get()).getValue() >= 1) {
			((LivingEntity) entity).getAttribute(EpicCoreApiModAttributes.SKILLPOINTS.get())
					.addPermanentModifier((new AttributeModifier(UUID.fromString("e51da438-1015-11ef-8f07-325096b39f47"), "skill_points_reduce", (-1), AttributeModifier.Operation.ADDITION)));
			...
			entity.getPersistentData().putBoolean("hidden_in_the_shadow", true);
		}
	}
}
