				...
				if (mainHandItem.is(ItemTags.create(new ResourceLocation("forge", "weapons/normal_weapon"))) && offHandItem.isEmpty()) {
					...
					if (world instanceof Level _level) {
						...
						if (!_level.isClientSide()) {
							_level.playSound(null, new BlockPos((int) x, (int) y, (int) z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("epic_core_api:charge_attack")), SoundSource.VOICE, 1, 1);
						} else {
							_level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("epic_core_api:charge_attack")), SoundSource.VOICE, 1, 1, false);
						}
					}
