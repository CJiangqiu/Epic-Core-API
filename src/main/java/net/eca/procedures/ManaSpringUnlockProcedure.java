	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (((LivingEntity) entity).getAttribute(EpicCoreApiModAttributes.SKILLPOINTS.get()).getValue() >= 1) {
			((LivingEntity) entity).getAttribute(EpicCoreApiModAttributes.SKILLPOINTS.get())
					.addPermanentModifier((new AttributeModifier(UUID.fromString("7e11ec4b-ab69-4c2f-9947-f0f448daabb3"), "skill_points_reduce", (-1), AttributeModifier.Operation.ADDITION)));
			...
			entity.getPersistentData().putBoolean("mana_spring", true);
		}
	}
}
