...
public class SkillPointsGuiScreen extends AbstractContainerScreen<SkillPointsGuiMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("epic_core_api:textures/screens/skill_points_gui.png"), this.leftPos + -155, this.topPos + -147, 0, 0, 512, 362, 512, 362);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font,
				...
				SkillPointsGetProcedure.execute(entity), 65, 180, -1, false);
	}
